...
<head>
  ...
  <title>BU JUPEB Portal | Login</title>
...
<body>
	<div id="header-wrapper">
		<div id="logo">
			<img src="<?php echo base_url(); ?>assets/Babcock_logo.jpg" alt="Babcock Logo">
			<span><h3>JOINT UNIVERSITIES PRELIMINARY EXAMINATION BOARD</h3></span>
		</div>
	</div>
  <div class="body"></div>
		<div class="grad"></div>
		<div class="header">
			<div class="headers">Users Login</div>
		</div>
